...
`,w=class extends b{constructor(){super(...arguments);this.isNew=!1;this.errorText="";this._count=1}willUpdate(e){e.has("device")&&(this._working={...this.device},this._count=1)}_set(e,i){this._working={...this._working,[e]:i}}render(){let e=this._working,[i,s]=E(e),n=e.type==="color_temp"||e.type==="rgbww";return d`
        ...
        <div class="dialog" @click=${r=>r.stopPropagation()}>
          ...
          <div class="row">
            <div>
              ...
              >
                ${Pe.map(r=>d`<option value=${r} ?selected=${e.type===r}>${r}</option>`)}
              </select>
            </div>
            <div>
    ...
    `}_backdropClick(){this._cancel()}_cancel(){this.dispatchEvent(new CustomEvent("panel-dialog-closed",{bubbles:!0,composed:!0}))}_save(){if(!this._working.name?.trim()){this.errorText="Name is required";return}this.dispatchEvent(new CustomEvent("save-device",{detail:{device:this._working,original:this.device,count:this.isNew?this._count:1},bubbles:!0,composed:!0}))}_delete(){this.dispatchEvent(new CustomEvent("delete-device",{detail:{device:this.device},bubbles:!0,composed:!0}))}};w.styles=pe,h([m({attribute:!1})],w.prototype,"device",2),h([m({type:Boolean})],w.prototype,"isNew",2),h([m()],w.prototype,"errorText",2),h([_()],w.prototype,"_working",2),h([_()],w.prototype,"_count",2),w=h([A("artnet-device-dialog")],w);var k=class extends b{constructor(){super(...arguments);this.isNew=!1;this.errorText="";this._newUniverse=""}willUpdate(e){e.has("node")&&(this._working={...this.node,universes:{...this.node.universes}},this._newUniverse="")}_set(e,i){this._working={...this._working,[e]:i}}_addUniverse(){let e=Number(this._newUniverse),i=C(this._working.node_type);if(this._newUniverse===""||!Number.isInteger(e)||e<i||e>1024){this.errorText=`Universe must be a whole number between ${i} and 1024`;return}if(this._working.universes[String(e)]){this.errorText=`Universe ${e} already exists`;return}this.errorText="",this._working={...this._working,universes:{...this._working.universes,[String(e)]:{send_partial_universe:!0,output_correction:"linear",devices:[]}}},this._newUniverse=""}_removeUniverse(e){if(this._working.universes[e]?.devices?.length)return;let i={...this._working.universes};delete i[e],this._working={...this._working,universes:i}}render(){let e=this._working;return d`
    ...
    `}_cancel(){this.dispatchEvent(new CustomEvent("panel-dialog-closed",{bubbles:!0,composed:!0}))}_save(){if(!this._working.host?.trim()){this.errorText="Host is required";return}let e=C(this._working.node_type),i=Object.keys(this._working.universes).filter(s=>Number(s)<e);if(i.length){this.errorText=`Universe ${i.join(", ")} is not allowed for ${this._working.node_type} (minimum is ${e}). Renumber it from the universe bar or remove it.`;return}this.dispatchEvent(new CustomEvent("save-node",{detail:{node:this._working,original:this.node},bubbles:!0,composed:!0}))}_delete(){this.dispatchEvent(new CustomEvent("delete-node",{detail:{node:this.node},bubbles:!0,composed:!0}))}};k.styles=pe,h([m({attribute:!1})],k.prototype,"node",2),h([m({type:Boolean})],k.prototype,"isNew",2),h([m()],k.prototype,"errorText",2),h([_()],k.prototype,"_working",2),h([_()],k.prototype,"_newUniverse",2),k=h([A("artnet-node-dialog")],k);var x=class extends b{constructor(){super(...arguments);this.mode="add";this.minUniverse=0;this.current="";this.existing=[];this._value="";this._error=""}willUpdate(e){(e.has("current")||e.has("mode"))&&(this._value=this.mode==="renumber"?this.current:String(this.minUniverse),this._error="")}render(){return d`
      <div class="backdrop" @click=${this._cancel}>
